...
//αφορα στα μέλη (υπαλληλους) που είναι υπεύθυνοι για την διαχείριση των περιουσιακών στοιχείων (Rents) και των τιμολογίων (installments) που συνδέονται με μια εταιρία (Tenancy ).
